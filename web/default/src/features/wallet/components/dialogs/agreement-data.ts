...
export const agreementDataMap: Record<string, AgreementData> = {
  zh: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '用户勾选同意本协议并点击支付、确认购买、提交订单、完成付款或实际使用 AI Token 的行为，即构成对本协议 of 有效确认和签署。',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '平台不保证 AI 输出内容完全准确、服务连续可用、满足用户特定目的，亦不保证输出内容不会与其他用户生成内容相同 or 相似。',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '如协议变更对用户既有已购买且未消耗 Token 的核心权益产生重大不利影响（实质性减少 Token 数量、显著缩短有效期、完全禁止原承诺模型的使用），平台应提供合理通知，并可选择提供同等价值的替代方案或按比例退还未使用 Token 对应费用，法律强制规定另有要求的除外。'
        ]
      },
      {
        title: '第十七条 适用法律与争议解决（境内外分设）',
        paragraphs: [
          '境内用户：本协议的订立、效力、履行、解释和争议解决，适用中华人民共和国法律（不含冲突法规则）；因本协议产生或与本协议有关的争议，双方应先友好协商解决；协商不成的，任一方应当提交服务方所在地有管辖权的人民法院诉讼解决。',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Output Content: Refers to the text, images, audio, video, code, analysis results, model replies, or other results generated or returned by the service based on the user\'s input content.',
      ...
      {
        title: 'Article 2 Agreement Signing and Electronic Confirmation',
        paragraphs: [
      ...
      {
        title: 'Article 3 Token Purchase, Pricing, and Delivery',
        paragraphs: [
          'Model rates, package prices, billing currencies, token numbers, validity terms, and consumption algorithms are as displayed on the platform payment page at the time of purchase.',
      ...
      {
        title: 'Article 4 Token Usage Rules',
        paragraphs: [
      ...
      {
        title: 'Article 5 Validity, Expiration, and Renewal',
        paragraphs: [
      ...
      {
        title: 'Article 6 Refund and Cancellation',
        paragraphs: [
      ...
      {
        title: 'Article 7 User Compliance Obligations',
        paragraphs: [
      ...
      {
        title: 'Article 8 AI Output Content and Risk Disclaimer',
        paragraphs: [
      ...
      {
        title: 'Article 9 Intellectual Property Rights',
        paragraphs: [
      ...
      {
        title: 'Article 10 Data Protection and Privacy',
        paragraphs: [
          ...
          'The platform may, within the necessary scope, entrust compliant third-party service providers to process data, including cloud providers, model providers, payment institutions, SMS service providers, invoicing service providers, customer support systems, data security service providers, etc., and require relevant third parties to take reasonable data protection measures.'
        ]
      },
      {
        title: 'Article 11 Taxes, Invoices, and Cross-Border Payments',
        paragraphs: [
      ...
      {
        title: 'Article 12 Service Modification, Interruption, and Maintenance',
        paragraphs: [
      ...
      {
        title: 'Article 13 Account Restrictions and Breach Treatment',
        paragraphs: [
      ...
      {
        title: 'Article 16 Agreement Modification',
        paragraphs: [
      ...
      {
        title: 'Article 17 Applicable Law and Dispute Resolution',
        paragraphs: [
      ...
      {
        title: 'Article 19 Miscellaneous',
        paragraphs: [
  ...
  fr: {
    ...
    sections: [
      ...
      {
        title: 'Article 2 Signature et validation',
        paragraphs: [
      ...
      {
        title: 'Article 3 Achat, tarification et livraison',
        paragraphs: [
      ...
      {
        title: 'Article 4 Règles d\'utilisation des jetons',
        paragraphs: [
      ...
      {
        title: 'Article 5 Validité, expiration et renouvellement',
        paragraphs: [
      ...
      {
        title: 'Article 6 Politique de remboursement et de rétractation',
        paragraphs: [
      ...
      {
        title: 'Article 7 Obligations de conformité de l\'utilisateur',
        paragraphs: [
      ...
      {
        title: 'Article 8 Risques et exclusions de responsabilité',
        paragraphs: [
      ...
      {
        title: 'Article 10 Protection des données et vie privée',
        paragraphs: [
      ...
      {
        title: 'Article 11 Taxes, factures et paiements transfrontaliers',
        paragraphs: [
      ...
      {
        title: 'Article 12 Modification, interruption et maintenance du service',
        paragraphs: [
      ...
      {
        title: 'Article 13 Restrictions de compte et traitement des violations',
        paragraphs: [
      ...
      {
        title: 'Article 14 Limitation de responsabilité',
        paragraphs: [
      ...
      {
        title: 'Article 16 Modification du contrat',
        paragraphs: [
      ...
      {
        title: 'Article 17 Droit applicable et règlement des différends',
        paragraphs: [
      ...
      {
        title: 'Article 18 Notifications',
        paragraphs: [
  ...
  ja: {
    ...
    sections: [
      ...
      {
        title: '第七条 ユーザーの法的義務と遵守事項',
        paragraphs: [
          'ユーザーは、中華人民共和国の法律、およびユーザーの所在地の法律、規制要件、業界の規範、輸出管理、経済制裁、データの国境を越えた転送規則、ならびに公序良俗を遵守することを誓約するものとします。',
          'ユーザーは、違法、他者の権利を侵害する、詐欺的、虚偽、憎悪表現、ハラスメント、暴力、アダルト、テロリズム、極端主義、自傷行為、自殺、薬物、武器、悪意のあるコード、サイバー攻撃、違法な金融活動など、規制に違反するコンテンツの生成や伝播を行ってはならず、その生成を支援してはなりません。',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'ユーザーが本規約を遵守し、対応する料金を支払っていることを前提として、プラットフォームは自らの権利の範囲内で、ユーザーに対して本サービスによって生成された出力内容の利用を許諾します。ただし、出力内容が排他的であるか、第三者の権利を侵害していないか、知的財産権として登録可能か、商業利用可能かについては、ユーザーが特定のコンテンツや適用される法律に基づいて自己判断するものとし、侵害のリスクはユーザー自身が負うものとします。',
      ...
      {
        title: '第十条 個人情報保護とプライバシー（国内外のコンプライアンス対応）',
        paragraphs: [
  ...
  ru: {
    ...
    sections: [
      ...
      {
        title: 'Статья 2 Подписание соглашения и электронное подтверждение',
        paragraphs: [
      ...
      {
        title: 'Статья 3 Покупка, тарификация и предоставление токенов',
        paragraphs: [
          ...
          'Пользователь должен гарантировать, что информация о заказе, учетной записи, счете-фактуре и лице, осуществляющем платеж, является достоверной, точной и полной; в случае если ошибки в данных пользователя приведут к сбою при пополнении, ошибкам в счете-фактурe, спорам о принадлежности аккаунта или иным убыткам, ответственность несет сам пользователь.'
        ]
      },
      {
        title: 'Статья 4 Правила использования токенов',
        paragraphs: [
      ...
      {
        title: 'Статья 5 Срок действия, истечение срока и продление',
        paragraphs: [
      ...
      {
        title: 'Статья 6 Возврат средств и отказ от услуг',
        paragraphs: [
      ...
      {
        title: 'Статья 7 Обязанности пользователя по соблюдению требований',
        paragraphs: [
      ...
      {
        title: 'Статья 8 Выходные данные ИИ и предупреждение о рисках',
        paragraphs: [
      ...
      {
        title: 'Статья 10 Защита данных и конфиденциальность',
        paragraphs: [
      ...
      {
        title: 'Статья 11 Налоги, счета-фактуры и трансграничные платежи',
        paragraphs: [
      ...
      {
        title: 'Статья 12 Изменение, прерывание и обслуживание услуг',
        paragraphs: [
      ...
      {
        title: 'Статья 13 Ограничение учетной записи и меры при нарушении',
        paragraphs: [
      ...
      {
        title: 'Статья 14 Ограничение ответственности',
        paragraphs: [
      ...
      {
        title: 'Статья 16 Изменение соглашения',
        paragraphs: [
      ...
      {
        title: 'Статья 17 Применимое право и разрешение споров',
        paragraphs: [
      ...
      {
        title: 'Статья 19 Прочие положения',
        paragraphs: [
          ...
          'Платформа может передать свои права и обязанности по настоящему соглашению в случае реорганизации бизнеса, слияния, разделения, передачи активов, перехода прав к аффилированным лицам или миграции услуг, но должна обеспечить, чтобы существующие права и интересы пользователей не были существенно ущемлены.',
  ...
  vi: {
    ...
    metaLabels: {
      ...
      declaration: 'Tuyên bố quan trọng: Thỏa thuận này là hợp đồng thương mại, không phải ý kiến pháp lý; trước khi chính thức đưa lên hệ thống, khuyến nghị nên hoàn tất việc kiểm tra cuối cùng kết hợp với quyền tài phán của người dùng, kênh thanh toán, yêu cầu tuân thủ về thuế và dữ liệu.',
    },
    sections: [
      {
      ...
      {
        title: 'Điều 2 Ký kết thỏa thuận và xác nhận điện tử',
        paragraphs: [
          ...
          'If người dùng là doanh nghiệp, tổ chức hoặc đoàn thể khác, người thay mặt đơn vị đó thực hiện mua hoặc sử dụng dịch vụ xác nhận đã được ủy quyền đầy đủ; trường hợp chưa được ủy quyền mà thay mặt người khác mua hoặc sử dụng dịch vụ thì người thao tác thực tế phải tự chịu trách nhiệm tương ứng.',
      ...
      {
        title: 'Điều 3 Mua, định giá và bàn giao Token',
        paragraphs: [
      ...
      {
        title: 'Điều 4 Quy tắc sử dụng Token',
        paragraphs: [
      ...
      {
        title: 'Điều 5 Thời hạn hiệu lực, hết hạn và nạp tiếp',
        paragraphs: [
      ...
      {
        title: 'Điều 6 Chính sách hoàn tiền và rút lui',
        paragraphs: [
      ...
      {
        title: 'Điều 7 Nghĩa vụ tuân thủ của người dùng',
        paragraphs: [
      ...
      {
        title: 'Điều 8 Nội dung đầu ra AI và Cảnh báo rủi ro',
        paragraphs: [
      ...
      {
        title: 'Điều 9 Quyền sở hữu trí tuệ',
        paragraphs: [
      ...
      {
        title: 'Điều 10 Bảo vệ dữ liệu và Quyền riêng tư',
        paragraphs: [
      ...
      {
        title: 'Điều 11 Thuế, Hóa đơn và Thanh toán xuyên biên giới',
        paragraphs: [
      ...
      {
        title: 'Điều 12 Thay đổi, Gián đoạn và Bảo trì dịch vụ',
        paragraphs: [
      ...
      {
        title: 'Điều 13 Hạn chế tài khoản và Xử lý vi phạm hợp đồng',
        paragraphs: [
      ...
      {
        title: 'Điều 14 Giới hạn trách nhiệm',
        paragraphs: [
      ...
      {
        title: 'Điều 16 Thay đổi thỏa thuận',
        paragraphs: [
      ...
      {
        title: 'Điều 17 Luật áp dụng và Giải quyết tranh chấp (phân biệt trong và ngoài nước)',
        paragraphs: [
