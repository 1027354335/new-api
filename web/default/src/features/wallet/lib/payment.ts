...
/**
 * Check if payment method is Alipay (dedicated)
 */
export function isAlipayPayment(paymentType: string, enableAlipayTopup?: boolean): boolean {
  return paymentType === PAYMENT_TYPES.ALIPAY && !!enableAlipayTopup
}
