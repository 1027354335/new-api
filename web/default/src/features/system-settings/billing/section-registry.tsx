    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          PayPalMode: settings.PayPalMode === 'live' ? 'live' : 'sandbox',
          PayPalCallbackUrl: settings.PayPalCallbackUrl ?? '',
          PayPalUsdToEurRate: settings.PayPalUsdToEurRate ?? 0.92,
          LexwareApiKey: settings.LexwareApiKey ?? '',
          ...
          AlipayCallbackUrl: settings.AlipayCallbackUrl ?? '',
          AlipayNotifyUrl: settings.AlipayNotifyUrl ?? '',
          AlipayUsdToCnyRate: settings.AlipayUsdToCnyRate ?? 7.2,
          AlipayBridgeEnabled: settings.AlipayBridgeEnabled ?? false,
          AlipayBridgeCreateUrl: settings.AlipayBridgeCreateUrl ?? '',
          AlipayBridgeSecret: settings.AlipayBridgeSecret ?? '',
        }}
        waffoDefaultValues={{
