...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  50: 'Format: AccessKey|SecretKey (or just ApiKey if upstream is OSS API)',
...
export const CHANNEL_TYPE_WARNINGS: Record<number, string> = {
  ...
  8: 'If connecting to upstream One API or OSS API relay projects, use OpenAI type instead unless you know what you are doing',
